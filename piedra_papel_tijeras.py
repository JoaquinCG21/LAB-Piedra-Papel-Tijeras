...
def jugar():
    ...
    eleccion_ordenador:str=ordenador_decide_jugada()
...
def jugar_torneo(puntos:int=3):
    print("Bienvenido al torneo del juego de piedra, papel o tijeras")

    puntos_usuario:int=0
    puntos_ordenador:int=0
